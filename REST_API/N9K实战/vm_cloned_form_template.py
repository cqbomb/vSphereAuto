...
def clone_vm_from_no(temp_no):
    ...
    vm_name = 'CentOS_'+str(vm_name_No)

    vm_folder = "vm_cloned_form_template"
...
if __name__ == "__main__":
    # choose_temp_No = input(Choose_VM_Banner+":")
    #print(type(choose_temp_No))
    # clone_vm_from_no(int(choose_temp_No))
    clone_vm_from_no(2)

# from SSH_to_ESXI import *
#
# if __name__ == "__main__":
#
...
#     print(VLAN_LIST)
#
#     if vm_name_No in VLAN_LIST:
#         print("VLAN is readly")
#     else:
#         # Create_VLAN =
